...
- `workflows/enrich/expand.md` (Procedure step 6)
- `workflows/create/synthesize.md` (Procedure step 8)
- `workflows/audit/enrichment-audit.md` (Phase 4 step 7)
...
- `workflows/meta/readme-github-maintenance.md` (Procedure step 8)
