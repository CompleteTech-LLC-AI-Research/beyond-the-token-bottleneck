...
- [ ] **All living analyses were reviewed per item**, not just per page. The current set of living analyses is enumerated in [`../procedures/living-analyses-review.md`](../procedures/living-analyses-review.md).
- [ ] **The [stale count sweep](../procedures/stale-count-sweep.md) was performed**, every common-offender file re-verified by name. Already in [`base.md`](base.md); reiterating because ingest is the highest-leverage place where the sweep prevents cascading regressions.
