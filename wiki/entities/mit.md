...
|------|-------|------|------------|
| May 2023 | [[multiagent-debate-du-et-al\|Multiagent Debate]] | Lead | **Foundational**: first proof LLM debate improves reasoning; +8pp GSM8K |
| May 2024 | [[platonic-representation-hypothesis\|Platonic Representation Hypothesis]] | Lead | Theoretical foundation for cross-model representation convergence |
| Dec 2025 | [[scaling-agent-systems\|Scaling Agent Systems]] | Co-lead (with Google) | Quantitative scaling framework; task-contingent coordination |
...
- **Yilun Du**: First author on multiagent debate; now at [[harvard|Harvard]]. The founder of the LLM debate paradigm. His move to Harvard creates a direct institutional link between the debate origins and Harvard's activation communication work.
- **Shuang Li**: Co-author on multiagent debate.
- **Antonio Torralba**: Senior advisor (MIT CSAIL); computer vision. His involvement bridges vision and language multi-agent research.
- **Joshua B. Tenenbaum**: Senior advisor (MIT BCS); computational cognitive science. His cognitive science perspective informs the debate-as-reasoning framework.
- **Igor Mordatch**: Co-author on multiagent debate (Google Brain, now [[google-deepmind|Google DeepMind]]); multi-agent systems. The key industry collaborator on the foundational paper.
- **Minyoung Huh**: First author on Platonic Representation Hypothesis. His convergence analysis provides the theoretical backbone for cross-model communication.
- **Phillip Isola**: Senior author on Platonic Representation Hypothesis. Leader of the representation learning group at MIT CSAIL.
