...
|------|-------|------|------------|
| Feb 2026 | [[latent-reasoning-supervision-analysis\|Cui et al. (Latent Reasoning Supervision Analysis)]] | Lead | Falsifies the strong-form parallel BFS hypothesis; identifies the supervision–exploration trade-off; proposes Improved Coconut (+7pp on GSM8K-Aug) |
...
- **Yingqian Cui** (first author, Michigan State University intern at Amazon): Designed the shortcut diagnostics and the BFS verification protocol. This was her Amazon internship work; her PhD is at Michigan State University with [[#Collaboration Network|Jiliang Tang]].
- **Zhenwei Dai** (Amazon): Co-lead on the experimental design.
- **Bing He, Zhan Shi, Hui Liu, Rui Sun, Zhiji Liu** (Amazon): Co-authors on the analysis pipeline.
- **Yue Xing** (Michigan State University): Senior collaborator on the statistical interpretation of the diversity metrics.
- **Jiliang Tang** (Michigan State University): Senior advisor; PhD supervisor of Yingqian Cui. Long-standing research interest in trustworthy ML and shortcut learning, which directly informed the shortcut-detection methodology.
- **Benoit Dumoulin** (Amazon): Senior advisor on the Amazon side.
