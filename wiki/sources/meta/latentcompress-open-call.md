...
3. **No layer selection analysis**: Compression operates on last-layer hidden states. [[kvcomm-selective-kv-sharing|KVComm]] and [[activation-communication-harvard|AC]] show that intermediate layers (~layer 26/32) often carry richer transferable information. Extracting from the optimal layer could improve compression efficiency.
